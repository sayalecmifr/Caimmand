...
| Prioridad           | Prioridad operativa (por defecto heredada de la Case Definition). No persistida como columna en el PoC; si se necesita, vive en `Context` (JSONB). |
| SLA                 | Tiempo maximo objetivo de resolucion (por defecto heredado). No persistido como columna en el PoC. |
